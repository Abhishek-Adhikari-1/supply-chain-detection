...
export default function DashboardPage() {
    ...
    const handleSearch = async () => {
        ...
        try {
            ...
            toast.error("Scan failed", {
                description:
                    err.response?.data?.error || "Failed to scan package",
            });
        } finally {
            setIsScanning(false);
        }
                ...
                <div className="max-w-4xl mx-auto space-y-8">
                    ...
                    <div className="text-center space-y-4 animate-fade-up">
                        ...
                        <p className="text-muted-foreground max-w-2xl mx-auto text-lg">
                            Upload your package.json or requirements.txt file,
                            or search for specific packages to detect potential
                            security threats in your dependencies.
                        </p>
                    </div>
                        ...
                        <div className="flex items-start justify-between gap-3">
                            <div>
                                ...
                                <p className="text-sm text-muted-foreground">
                                    Streams start/log/complete events in real
                                    time while the backend scanner runs.
                                </p>
                            </div>
                            <span
                        ...
                        <div className="space-y-4">
                            ...
                            <div>
                                ...
                                <p className="text-sm text-muted-foreground mt-1">
                                    or click to select (package.json,
                                    requirements.txt)
                                </p>
                            </div>
                        </div>
