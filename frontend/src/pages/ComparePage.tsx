                ...
                <div className="max-w-5xl mx-auto space-y-8">
                    ...
                    <div className="text-center space-y-4 animate-fade-up">
                        ...
                        <p className="text-muted-foreground max-w-2xl mx-auto text-lg">
                            Enter package names to compare their security risks
                            side by side and choose the safest option for your
                            project.
                        </p>
                    </div>
                            ...
                            <CardTitle className="flex items-center gap-2">
                                ...
                                <div>
                                    ...
                                    <span className="text-sm font-normal text-muted-foreground">
                                        Enter package names and versions to
                                        compare
                                    </span>
                                </div>
                            </CardTitle>
                        ...
                        >
                            <CardContent className="p-12 text-center">
                                ...
                                <p className="text-muted-foreground max-w-md mx-auto">
                                    Enter package names above and click Compare
                                    to see a side-by-side security analysis
                                </p>
                            </CardContent>
                        </Card>
                    )}
